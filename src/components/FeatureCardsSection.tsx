...
Полный спектр услуг
            ...
            >
              <p className="text-zinc-400 leading-relaxed">
                Мы берём на себя все рутинные задачи, связанные с автомобилями:
                от техобслуживания до страхования и сопровождения ДТП.{" "}
