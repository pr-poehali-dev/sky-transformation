        ...
        <div className="relative z-10 pt-28 flex flex-col">
          ...
          <div className="w-full flex justify-center px-6 mt-16">
            <div className="w-full max-w-4xl">
              ...
              >
                Бизнес-автоконсьерж для вашей компании
              </motion.h1>
              <motion.p
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
              ...
              >
                Освобождаем время вашей команды от рутины с автомобилями.
                <br />
                Полное сопровождение корпоративного автопарка — от ТО до страхования.
              </motion.p>
              <motion.div
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
              ...
              >
                ...
                <button className="text-zinc-300 font-medium hover:text-white transition-colors flex items-center gap-2 text-sm">
                  <span className="text-zinc-500">От 1 до 100+ авто</span> — масштабируемый сервис
